...
At the moment per gallery settings are not available, default settings are applied to all galleries. I'll check in to the possibility to add per gallery settings in the future.

For best result all images should have the same height; if images have different heights the gallery will cut images larger than the first image.
